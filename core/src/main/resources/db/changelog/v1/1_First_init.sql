...
INSERT INTO `trustmeenglish`.users (email, password)VALUES ('abc@gmail.com', '12345');
...
CREATE TABLE `trustmeenglish`.`user_roles`
(
...
INSERT INTO `trustmeenglish`.user_roles (`user_id`, `role_id`)VALUES ('1', '1');
